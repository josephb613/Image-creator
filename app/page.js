...
const SelectInput = ({ label, value, options, onChange }) => (
  <div className="mb-4">
    ...
    <select value={value} onChange={onChange} className="w-full bg-gray-700 rounded p-2 text-sm">
  ...
  <div className="mb-4">
    ...
    <div className="grid grid-cols-2 gap-2">
      {options.map((option, index) => (
        <button
          key={index}
          className={`p-2 rounded text-sm ${value === option ? 'bg-purple-600' : 'bg-gray-700'}`}
          ...
          <div className="bg-gray-800 p-4 rounded-lg shadow-lg">
            <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
              <SelectInput
                label="Préréglage"
                value={preset}
                options={['Cinématique', 'Artistique', 'Réaliste']}
                onChange={(e) => setPreset(e.target.value)}
              />
              <SelectInput
                label="Style"
                value={style}
                options={['Dynamique', 'Doux', 'Contrasté']}
                onChange={(e) => setStyle(e.target.value)}
              />
              <SelectInput
                label="Contraste"
